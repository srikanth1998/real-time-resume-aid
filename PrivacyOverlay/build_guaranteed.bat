@echo off
echo Building Guaranteed Privacy Overlay...
...
echo Compiling simplified guaranteed privacy overlay...
cl /EHsc /W4 /std:c++17 /O2 /Fe:build\GuaranteedOverlay.exe GuaranteedOverlay.cpp /link user32.lib gdi32.lib dwmapi.lib gdiplus.lib
...
echo Executable location: build\GuaranteedOverlay.exe
