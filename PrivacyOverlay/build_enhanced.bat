...
echo Compiling enhanced privacy overlay with indicator...
cl /EHsc /W4 /std:c++17 /O2 /Fe:build\EnhancedPrivacyOverlay.exe PrivacyOverlay.cpp /link user32.lib gdi32.lib dwmapi.lib comctl32.lib ole32.lib
...
echo Executable location: build\EnhancedPrivacyOverlay.exe
