@echo off
echo Building True Stealth Privacy Overlay...
...
echo Compiling True Stealth privacy overlay...
cl /EHsc /W4 /std:c++17 /O2 /Fe:build\TrueStealth.exe TrueStealth.cpp /link user32.lib gdi32.lib dwmapi.lib gdiplus.lib
...
echo Executable location: build\TrueStealth.exe
